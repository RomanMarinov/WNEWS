...
import com.dev_marinov.wnews.databinding.FragmentWebViewTechnologyBinding
import dagger.hilt.android.AndroidEntryPoint

@SuppressLint("SetJavaScriptEnabled")
@AndroidEntryPoint
class TechnologyWebViewFragment : Fragment() {
    private lateinit var binding: FragmentWebViewTechnologyBinding
    lateinit var viewModel: TechnologyWebViewViewModel
    private lateinit var callback: OnBackPressedCallback
    private val args: TechnologyWebViewFragmentArgs by navArgs()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        Log.e("444", "зашел в FragmentWebView")
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_web_view_technology, container, false)
        viewModel = ViewModelProvider(requireActivity())[TechnologyWebViewViewModel::class.java]
