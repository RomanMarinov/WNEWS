...
class EntertainmentFragment : Fragment() {
    ...
    private fun setLayout(column: Int){
        ...
        val adapter = EntertainmentAdapter(viewModel::onClick, viewModel::onClickFavorite)
    ...
    private fun navigateToWebViewFragment(url: String) {
        val action = HomeFragmentDirections.actionViewPager2FragmentToEntertainmentWebViewFragment(url)
