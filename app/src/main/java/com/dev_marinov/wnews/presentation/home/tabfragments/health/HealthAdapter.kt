package com.dev_marinov.wnews.presentation.home.tabfragments.health
...
) : ListAdapter<SelectableFavoriteNews, HealthAdapter.ViewHolder>(AllNewsDiffUtilCallback()) {
