...
import com.dev_marinov.wnews.databinding.FragmentWebViewScienceBinding
import dagger.hilt.android.AndroidEntryPoint

@SuppressLint("SetJavaScriptEnabled")
@AndroidEntryPoint
class ScienceWebViewFragment : Fragment() {
    private lateinit var binding: FragmentWebViewScienceBinding
    lateinit var viewModel: ScienceWebViewViewModel
    private lateinit var callback: OnBackPressedCallback
    private val args: ScienceWebViewFragmentArgs by navArgs()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        Log.e("444", "зашел в FragmentWebView")
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_web_view_science, container, false)
        viewModel = ViewModelProvider(requireActivity())[ScienceWebViewViewModel::class.java]
