...
import com.dev_marinov.wnews.databinding.FragmentWebViewHealthBinding
import dagger.hilt.android.AndroidEntryPoint

@SuppressLint("SetJavaScriptEnabled")
@AndroidEntryPoint
class HealthWebViewFragment : Fragment() {
    private lateinit var binding: FragmentWebViewHealthBinding
    lateinit var viewModel: HealthWebViewViewModel
    private lateinit var callback: OnBackPressedCallback
    private val args: HealthWebViewFragmentArgs by navArgs()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        Log.e("444", "зашел в FragmentWebView")
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_web_view_health, container, false)
        viewModel = ViewModelProvider(requireActivity())[HealthWebViewViewModel::class.java]
