...
import com.dev_marinov.wnews.databinding.FragmentWebViewEntertainmentBinding
import dagger.hilt.android.AndroidEntryPoint

@SuppressLint("SetJavaScriptEnabled")
@AndroidEntryPoint
class EntertainmentWebViewFragment : Fragment() {
    private lateinit var binding: FragmentWebViewEntertainmentBinding
    lateinit var viewModel: EntertainmentWebViewViewModel
    private lateinit var callback: OnBackPressedCallback
    private val args: EntertainmentWebViewFragmentArgs by navArgs()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        Log.e("444", "зашел в FragmentWebView")
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_web_view_entertainment, container, false)
        viewModel = ViewModelProvider(requireActivity())[EntertainmentWebViewViewModel::class.java]
